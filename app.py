...
from brevo import send_certificate_email
...
#         send_certificate_email(username, email, final_pdf.read(), certificate_type=certificate_type)
...
#         send_certificate_email(username, email, final_pdf.read(), certificate_type='Melhor Expositor')
...
#         send_certificate_email(username, email, final_pdf.read(), certificate_type='Melhor Stand')
...
def partcipants():
    ...
    with open("certificates/gensummit/Digital.pdf", "rb") as f:
        ...
        send_certificate_email(username, email, final_pdf.read(), certificate_type='Participante')
